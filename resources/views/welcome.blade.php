    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="tm-heroslider-area bg-grey">
            <div class="tm-heroslider-slider">
                <div class="tm-heroslider" data-bgimage="assets/images/2.png">
                    <div class="container">
                        <div class="row align-items-center">
                ...
                <div class="tm-heroslider" data-bgimage="assets/images/1.png">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-7 col-md-8 col-12">
                                <div class="tm-heroslider-contentwrapper">
                    ...
                    <div class="row mt-30-reverse">
                        <div class="col-lg-4 mt-30">
                            <div class="tm-feature">
                                <span class="tm-feature-icon">
                                    <img 
                                        alt="mision" src="assets/images/icons/icon-free-shipping.png"
                                       >
                                </span>
                        ...
                        <div class="col-lg-4 mt-30">
                            <div class="tm-feature">
                                <span class="tm-feature-icon">
                                    <img 
                                        alt="Vision" src="assets/images/icons/icon-fast-delivery.png"
                                       >
                                </span>
                                <div class="tm-feature-content">
                                    <h6>Vision</h6>
                        ...
                        <div class="col-lg-4 mt-30">
                            <div class="tm-feature">
                                <span class="tm-feature-icon">
                                    <img  alt="objetivo" src="assets/images/icons/icon-247-support.png">
                                </span>
                                <div class="tm-feature-content">
                                    <h6>Objetivo</h6>
                    ...
                    <div class="widgets widgets-footer row">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="single-widget widget-info">
                                <a class="widget-info-logo" href="#"><img src="assets/images/logoe.png"
                                        alt="logo"></a>
